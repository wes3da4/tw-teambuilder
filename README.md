...
- **スキル・バフデバフ計算システム** — PTに編成したメンバー構成から有効なバフ・デバフをカテゴリ別に表示
- **マスタリー選択** — キャラクターごとのマスタリーを選択可能に
- **育成型（ビルドタイプ）選択** — キャラクターごとの「型」を選択可能に
- **キャラクター間シナジー** — 「チームメンバーに〇〇がいると」系のパッシブシナジースキルを表示。メンバーカードのドラッグ中、シナジー関係にあるキャラクターのアイコンをハイライト表示
- **メンバーのテキスト共有** — メンバー管理からメンバー情報をエクスポートインポート可能
